...
## 🧭 What I Do
- Design and build distributed backend systems at scale
- Own system reliability, performance, and production stability
- Drive cloud cost optimization and security improvements
- Lead technical initiatives across cross-region teams
...
**Backend:** Spring Boot, Spring, Quarkus, FastAPI  
**Frontend:** Angular  
**Cloud:** AWS (Lambda, API Gateway, DynamoDB, S3, ECS, SQS, CloudWatch, CloudFront, Route 53)  
**DevOps & Infra:** Docker, GitLab CI/CD, Terraform, CloudFormation  
...
- Reduced **API failures ~30%** by migrating legacy services to AWS serverless architectures
- Built multi-threaded Java pipelines processing **high-volume, real-time data** (finance & aviation)
- Integrated security tooling into CI/CD, fixing **100+ vulnerabilities early in the pipeline**

---

## 🧠 Engineering Philosophy
- Build systems that scale beyond MVPs
- Prefer clear ownership over shared confusion
...
## 📫 Let’s Connect
- LinkedIn: https://linkedin.com/in/ktsunkara
- GitHub: https://github.com/ktsunkara9
